-- ============================================================
-- Kombinierter Migrationsblock für die Anfragen-Inbox
-- Enthält: 20260521140000_inquiries.sql + 20260521160000_inquiries_extra.sql
-- Idempotent — kann beliebig oft ausgeführt werden.
--
-- Anwenden im Supabase-Dashboard:
-- https://supabase.com/dashboard/project/vejhsyrxpveunygyhqlo/sql/new
-- ============================================================

-- ---------- Migration 20260521140000: inquiries-Tabelle ----------
...
-- ---------- Migration 20260521160000: notes_log + priority ----------
...
--    where table_name = 'inquiries' order by column_name;
-- ============================================================
